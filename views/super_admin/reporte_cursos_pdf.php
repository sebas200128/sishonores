<?php
// vista/super_admin/reporte_cursos_pdf.php
...
// Obtener datos de cursos del Modelo
...
<head>
    ...
    <title>Reporte de Cursos y Plan de Estudios - SisHonores</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-title">
        Reporte General de Cursos Habilitados
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 20%;">Código Curso</th>
                <th style="width: 40%;">Nombre de Curso</th>
                <th class="text-center" style="width: 15%;">Horas Semanales</th>
                <th style="width: 17%;">Nivel Educativo</th>
            </tr>
        </thead>
        <tbody>
            <?php if (empty($cursos)): ?>
                <tr>
                    <td colspan="5" class="text-center">No hay cursos registrados en el sistema.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($cursos as $idx => $curso): ?>
                    <tr>
                        ...
                        <td class="text-center"><?php echo htmlspecialchars($curso['horas_semanales']); ?> hrs</td>
                        <td><?php echo htmlspecialchars($curso['nombre_nivel']); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
        </tbody>
