...
// Usar el Modelo para listar cursos
...
<body>
    ...
    <script>
        function guardarCurso() {
            $.ajax({url: 'index.php?controller=curso', method: 'POST', data: $('#formCurso').serialize() + '&action=guardar', success: function(r){location.reload();}});
        }
        function editarCurso(id) {
            $.ajax({url: 'index.php?controller=curso&action=get&id='+id, method: 'GET', success: function(curso){
        ...
        function eliminarCurso(id) {
            if(confirm('¿Eliminar este curso?')) $.ajax({url: 'index.php?controller=curso&action=delete&id='+id, method: 'GET', success: function(){location.reload();}});
        }
    </script>
</body>
</html>
