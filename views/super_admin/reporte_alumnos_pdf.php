<?php
// vista/super_admin/reporte_alumnos_pdf.php
...
// Obtener datos de alumnos del Modelo
...
<head>
    ...
    <title>Reporte de Alumnos Matriculados - SisHonores</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-title">
        Reporte Oficial de Alumnos Matriculados
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 15%;">Grado y Sección</th>
                <th style="width: 23%;">Apoderado / Email</th>
            </tr>
        </thead>
        <tbody>
            <?php if (empty($alumnos)): ?>
                <tr>
                    <td colspan="6" class="text-center">No hay alumnos registrados en el sistema.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($alumnos as $idx => $alumno): ?>
                    <tr>
                        <td class="text-center"><?php echo $idx + 1; ?></td>
                        <td><strong><?php echo htmlspecialchars($alumno['codigo_estudiante']); ?></strong></td>
                        <td><?php echo htmlspecialchars($alumno['apellidos'] . ', ' . $alumno['nombres']); ?></td>
                        <td><?php echo htmlspecialchars($alumno['dni']); ?></td>
                        <td><?php echo htmlspecialchars($alumno['nombre_grado'] . ' "' . $alumno['nombre_seccion'] . '"'); ?></td>
                        <td>
                            <?php echo htmlspecialchars($alumno['nombre_apoderado']); ?><br>
                            <span style="font-size: 11px; color: #7f8c8d;"><?php echo htmlspecialchars($alumno['email_apoderado']); ?></span>
                        </td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
    ...
    <script>
        // Lanzar la impresión automática al cargar
