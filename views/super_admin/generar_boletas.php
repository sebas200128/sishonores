...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="index.php" target="_blank" class="row g-3">
                    <input type="hidden" name="controller" value="director">
                    <input type="hidden" name="action" value="boletas_pdf">
                    <div class="col-md-6">
                        <label>Alumno</label>
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="index.php" class="row g-3">
                                <input type="hidden" name="controller" value="director">
                                <input type="hidden" name="action" value="generar_boletas_masivas">
                                <div class="col-md-4">
                                    <label>Nivel</label>
    ...
    <script>
        $('#selectNivel').change(function() {
            ...
            if(id_nivel) {
                $.ajax({url: 'index.php?controller=director&action=generar_boletas_masivas&subaction=get_grados&id_nivel='+id_nivel, method: 'GET', dataType: 'json', success: function(data){
