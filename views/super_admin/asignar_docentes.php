...
<body>
    ...
    <script>
        function cargarAsignaciones() {
            $.ajax({url: 'index.php?controller=asignacion&action=listar', method: 'GET', success: function(data) {$('#listaAsignaciones').html(data);}});
        }
        $('#selectAula').change(function() {
            let id_aula = $(this).val();
            if(id_aula) {
                $.ajax({url: 'index.php?controller=asignacion', method: 'POST', data: {action: 'get_cursos', id_aula: id_aula}, dataType: 'json', success: function(data) {
        ...
        function asignarDocente() {
            ...
            $.ajax({url: 'index.php?controller=asignacion', method: 'POST', data: data, dataType: 'json', success: function(r){
                if(r.success){
        ...
        function eliminarAsignacion(id) { if(confirm('¿Eliminar?')) $.ajax({url: 'index.php?controller=asignacion&action=eliminar&id='+id, method: 'GET', success: function(){cargarAsignaciones();}}); }
