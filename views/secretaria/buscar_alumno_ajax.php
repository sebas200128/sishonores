        ...
        foreach ($alumnos as $idx => $a) {
            ...
            echo '<tr>
                    ...
                    <td class="text-center">
                        <a href="index.php?controller=secretaria&action=ver_notas_detalle&id=' . $a['id_alumno'] . '" class="btn btn-sm btn-primary"><i class="fas fa-eye"></i> Notas</a> 
                        <a href="index.php?controller=director&action=boletas_pdf&id_alumno=' . $a['id_alumno'] . '&bimestre=0" target="_blank" class="btn btn-sm btn-danger"><i class="fas fa-file-pdf"></i> Boleta</a>
                    </td>
                  </tr>';
        }
