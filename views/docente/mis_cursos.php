                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p><strong>Sección:</strong> <?php echo $curso['nombre_seccion']; ?></p>
                                     <a href="index.php?controller=docente&action=ingresar_notas&curso=<?php echo $curso['id_docente_curso_aula']; ?>" class="btn btn-primary"><i class="fas fa-edit"></i> Ingresar Notas</a>
                                     <a href="index.php?controller=docente&action=competencias&curso=<?php echo $curso['id_docente_curso_aula']; ?>" class="btn btn-info"><i class="fas fa-tasks"></i> Competencias</a>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; ?>
