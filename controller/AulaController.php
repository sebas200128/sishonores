<?php
// controller/AulaController.php

require_once __DIR__ . '/../util/Database.php';
require_once __DIR__ . '/../dao/AulaDAO.php';
...
try {
    ...
    if ($action === 'guardar') {
        ...
        if ($aulaDAO->checkAulaDuplicada($id_grado, $id_seccion, $anio, $id)) {
