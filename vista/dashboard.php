...
if ($rol == 'SuperUsuario' || $rol == 'Director') {
    $links = [
        ['url' => app_url('super_admin/usuarios.php'), 'icon' => 'fa-chart-line', 'titulo' => 'Sistema de Notas', 'desc' => 'Gestión académica integrada', 'color' => 'primary'],
        ['url' => app_url('super_admin/generar_boletas.php'), 'icon' => 'fa-file-pdf', 'titulo' => 'Reportes en Línea', 'desc' => 'Generación de boletas y actas', 'color' => 'success'],
        ['url' => app_url('super_admin/alumnos.php'), 'icon' => 'fa-comments', 'titulo' => 'Gestión de Alumnos', 'desc' => 'Administración de estudiantes', 'color' => 'info']
    ];
} elseif ($rol == 'Docente') {
    $links = [
    ...
    $links = [
        ...
        ['url' => app_url('padre/mis_hijos.php'), 'icon' => 'fa-file-pdf', 'titulo' => 'Mis Hijos', 'desc' => 'Información de estudiantes', 'color' => 'success'],
