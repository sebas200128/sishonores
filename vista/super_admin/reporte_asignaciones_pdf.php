<?php
// vista/super_admin/reporte_asignaciones_pdf.php

require_once '../../util/Database.php';
require_once '../../dao/AsignacionDocenteDAO.php';
...
// Obtener datos de asignaciones del DAO
$asignaciones = $asignacionDAO->listarAsignacionesAnioActual();
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Reporte de Asignaciones de Docentes - SisHonores</title>
    <style>
        body {
...
<body>
    ...
    <div class="report-title">
        Reporte de Asignaciones de Docentes a Cursos
    </div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th style="width: 27%;">Aula (Grado y Sección)</th>
            </tr>
        </thead>
        <tbody>
            <?php if (empty($asignaciones)): ?>
                <tr>
                    <td colspan="4" class="text-center">No hay asignaciones de docentes registradas en el sistema.</td>
                </tr>
            <?php else: ?>
                <?php foreach ($asignaciones as $idx => $asig): ?>
                    <tr>
                        <td class="text-center"><?php echo $idx + 1; ?></td>
                        <td><strong><?php echo htmlspecialchars($asig['apellidos'] . ', ' . $asig['nombres']); ?></strong></td>
                        <td><?php echo htmlspecialchars($asig['nombre_curso']); ?></td>
                        <td><?php echo htmlspecialchars($asig['nombre_grado'] . ' "' . $asig['nombre_seccion'] . '"'); ?></td>
                    </tr>
                <?php endforeach; ?>
            <?php endif; ?>
        </tbody>
