...
$aulaDAO = new AulaDAO($db);

// Usar el DAO en lugar de consulta directa
$aulas = $aulaDAO->listarTodas();
...
<body>
    ...
    <script>
        function guardarAula() {
            $.ajax({url: '../../controller/AulaController.php', method: 'POST', data: $('#formAula').serialize() + '&action=guardar', success: function(r){location.reload();}});
        }
        function editarAula(id) {
            $.ajax({url: '../../controller/AulaController.php?action=get&id='+id, method: 'GET', success: function(aula){
        ...
        function eliminarAula(id) {
            if(confirm('¿Eliminar esta aula?')) $.ajax({url: '../../controller/AulaController.php?action=delete&id='+id, method: 'GET', success: function(){location.reload();}});
        }
    </script>
</body>
</html>
