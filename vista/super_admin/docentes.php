...
// Usar el DAO para listar docentes
$docentes = $usuarioDAO->listarDocentes();
?>
<?php
...
<body>
    ...
    <script>
        ...
        function editarDocente(id) {
            ...
            $.ajax({
                url: '../../controller/DocenteController.php?action=get&id=' + id,
                method: 'GET',
                dataType: 'json',
        ...
        function eliminarDocente(id) {
            if (confirm('¿Está seguro de que desea eliminar a este docente? Esta acción también eliminará todas sus asociaciones de nivel y curso.')) {
                $.ajax({
                    url: '../../controller/DocenteController.php?action=delete&id=' + id,
                    method: 'GET',
                    dataType: 'json',
        ...
        $('#formDocente').on('submit', function(e) {
            ...
            $.ajax({
                url: '../../controller/DocenteController.php?action=guardar',
                method: 'POST',
                data: $(this).serialize(),
                dataType: 'json',
                success: function(res) {
