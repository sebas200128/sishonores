...
<head>
    ...
    <title>Imprimir Boleta - SisHonores</title>
...
<body>
    ...
    <div class="container-fluid">
        <h1><i class="fas fa-print"></i> Imprimir Boleta de Notas</h1>
        <div class="card">
            <div class="card-body">
                <div class="input-group mb-3"><input type="text" class="form-control" id="dniBuscar" placeholder="DNI del alumno"><button class="btn btn-primary" onclick="buscarAlumno()">Buscar</button></div>
