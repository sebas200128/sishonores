...
<body>
    ...
    <script>
        function verNotas(id){ $.ajax({url:'ver_notas_ajax.php',method:'POST',data:{id_alumno:id},success:function(data){$('#modalContenido').html(data);$('#modalNotas').modal('show');}}); }
        function verComentarios(id){ $.ajax({url:'comentarios_ajax.php',method:'POST',data:{id_alumno:id},success:function(data){$('#modalContenido').html(data);$('#modalNotas').modal('show');}}); }
    </script>
</body>
</html>
